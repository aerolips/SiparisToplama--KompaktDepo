...
if rewards[current_state[0], current_state[1]] == 50 and visited_50_reward == True:
    ...
    if kat == -1:
        ...
        capacity_values[current_state[0], current_state[1]] -= kapasite
...
if current_state[0] == 5 and current_state[1] == 3 and capacity_values[5,3] == 1:
    if kat == 1:
        if kapasite > 1:
            ...
            kat = -1
            capacity_values[current_state[0], current_state[1]] += (kapasite - 1)
            kapasite = 0
